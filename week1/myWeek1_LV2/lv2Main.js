import { createApp, ref, reactive } from 'https://cdnjs.cloudflare.com/ajax/libs/vue/3.0.9/vue.esm-browser.js'



const App = {
  setup() {
    const listNum = ref(null);
    ...
    return { listNum, products, clickItem };
  }
}
